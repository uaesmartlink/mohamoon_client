...
import 'package:client_mohamoon/app/utils/helpers/validation.dart';
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  IntlPhoneField(
                    ...
                    onSaved: (phone) {
                      controller.phone = phone == null ? '' : phone.number;
                    },
                  ),
                  SizedBox(
                    height: 15,
                      ...
                      () => Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              await launchUrl(Uri.parse(
                                  'https://tatbeeb.app/term-and-condition/'));
                            },
                            child: Text(
                              'terms of service'.tr,
                              style: TextStyle(
                          ...
                          InkWell(
                            onTap: () async {
                              await launchUrl(Uri.parse(
                                  'https://tatbeeb.app/privacy-policy/'));
                            },
                            child: Text(
                              'privacy policy'.tr,
                              style: TextStyle(
